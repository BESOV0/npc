...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  //div add
   INSTPAT("0000001 ????? ????? 000 ????? 0111011", mulw   , R, R(dest) = SEXTS(BITS(((int64_t)src1 * (int64_t)src2),31,0),32));
  INSTPAT("0000001 ????? ????? 100 ????? 0111011", divw   , R, R(dest) = SEXTS((int32_t)BITS((int64_t)src1,31,0)/(int32_t)BITS((int64_t)src2,31,0),32));
  INSTPAT("0000001 ????? ????? 100 ????? 0110011", div    , R, R(dest) = (int64_t)src1 /(int64_t)src2);
  //goldbach add
  INSTPAT("0000001 ????? ????? 110 ????? 0111011", remw   , R, R(dest) = SEXTS((int32_t)BITS((int64_t)src1,31,0) % (int32_t)BITS((int64_t)src2,31,0),32));
  //if else add
